...
describe('<RecipeListItem />', () => {
  test('Should not break if no recipe is passed', () => {
  ...
  test('Should call onClick when clicked', () => {
    ...
    const component = mount(<RecipeListItem recipe={testRecipe} onClick={onClick}/>);
  ...
  test('Should not call onClick when onFavorited is called', () => {
    ...
    const component = mount(<RecipeListItem recipe={testRecipe} onFavorited={onFavorited} onClick={onClick}/>);
